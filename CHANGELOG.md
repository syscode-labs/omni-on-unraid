...
## [0.3.0](https://github.com/syscode-labs/omni-on-unraid/compare/v0.2.1...v0.3.0) (2026-09-25)


### Features

* add NodeLocal DNSCache for libvirt Talos 1.14 ([9003f6e](https://github.com/syscode-labs/omni-on-unraid/commit/9003f6e8718adde40bcb135bfe5c15473f2c2bc2))
* add NodeLocal DNSCache for libvirt Talos 1.14 ([9532d3d](https://github.com/syscode-labs/omni-on-unraid/commit/9532d3dcac759baa427117b53e58f0db6c63fd3e))
...
* align omnictl with Omni 1.11 backend ([34ee2e9](https://github.com/syscode-labs/omni-on-unraid/commit/34ee2e982e9818efb35fbc030836d1760700f408))
* align omnictl with Omni 1.11 backend ([6c93236](https://github.com/syscode-labs/omni-on-unraid/commit/6c932366e1bf52089d8f6856e46c522d82b684c2))
* apply NodeLocal DNS to all Talos 1.14 providers ([09c8f11](https://github.com/syscode-labs/omni-on-unraid/commit/09c8f11550eea9901215b7961e7fd14f90874260))
* apply NodeLocal DNS to all Talos 1.14 providers ([f22c375](https://github.com/syscode-labs/omni-on-unraid/commit/f22c3750a16a53907e90f10ace06ebc9b38c97c5))
* avoid duplicate control-plane taint removal ([c64893c](https://github.com/syscode-labs/omni-on-unraid/commit/c64893cd7f6ff686851c4b7178b6e75a8b362eee))
...
* complete guarded Imp resize placement ([#39](https://github.com/syscode-labs/omni-on-unraid/issues/39)) ([2bbbfa9](https://github.com/syscode-labs/omni-on-unraid/commit/2bbbfa90e738b4e7c98fd3ccbee0bc42d2d25d03))
...
* guard asymmetric Imp control-plane placement ([d801a8b](https://github.com/syscode-labs/omni-on-unraid/commit/d801a8bf535dabda5fd90d075e9153157ed037a7))
* guard asymmetric Imp control-plane placement ([244b5f9](https://github.com/syscode-labs/omni-on-unraid/commit/244b5f99dbf537a660bf7f3fae06c5b33ae3a646))
...
* make peer placement cleanup idempotent ([#38](https://github.com/syscode-labs/omni-on-unraid/issues/38)) ([d3d1b74](https://github.com/syscode-labs/omni-on-unraid/commit/d3d1b743a7315c50fc3e68996cfe33f31180dfba))
...
* permit guarded Imp node recovery resize ([#36](https://github.com/syscode-labs/omni-on-unraid/issues/36)) ([2bd6df8](https://github.com/syscode-labs/omni-on-unraid/commit/2bd6df84c420644c83dfe381a2067269117e3775))
...
* reconcile libvirt control-plane taint once ([5256cee](https://github.com/syscode-labs/omni-on-unraid/commit/5256cee052b05cf5ba72e3d5749c29635ad6e67c))
...
* remove conflicting legacy libvirt Talos 1.14 fields ([e45e9e4](https://github.com/syscode-labs/omni-on-unraid/commit/e45e9e4dd35203a5d3d0a621371e576b1ee78c98))
...
* render KubeNodeConfig taint as scalar ([#37](https://github.com/syscode-labs/omni-on-unraid/issues/37)) ([c9db640](https://github.com/syscode-labs/omni-on-unraid/commit/c9db6401206ba18861f6c9f09793e6e9c1aa22f0))
...
* request qemu guest agent for libvirt schematics ([fee889a](https://github.com/syscode-labs/omni-on-unraid/commit/fee889aa20b27f3d512f5e1427809dbde1dbe634))
* request qemu guest agent for libvirt schematics ([d2de431](https://github.com/syscode-labs/omni-on-unraid/commit/d2de4312522a7a4c8605ad045f2817044bdccff2))
* route Kubernetes proxy without host matching ([#40](https://github.com/syscode-labs/omni-on-unraid/issues/40)) ([aaf6cad](https://github.com/syscode-labs/omni-on-unraid/commit/aaf6cad6ef31eac6b213ac88a88546d22997ac34))
...
* split libvirt control-plane scheduling patches ([4f6d5f8](https://github.com/syscode-labs/omni-on-unraid/commit/4f6d5f87a1fbd235944c9b41a25f8e4161893033))
* split libvirt control-plane scheduling patches ([d973e6b](https://github.com/syscode-labs/omni-on-unraid/commit/d973e6b1799d6242bec0281adf5846d846562146))
* **talos:** make control-plane taint removal idempotent ([444aa24](https://github.com/syscode-labs/omni-on-unraid/commit/444aa24c8a14ab34bd128d3ee776823f527e5f34))
* **talos:** make control-plane taint removal idempotent ([08e5fd7](https://github.com/syscode-labs/omni-on-unraid/commit/08e5fd75caf0ce315d960e6cde3c1c1257b0c0e5))
* **talos:** revert patch rejected by Omni template validation ([75b205b](https://github.com/syscode-labs/omni-on-unraid/commit/75b205ba88d97f02af864143e3f5385211e3b3f3))
* **unraid:** schedule Hubble on control planes ([8873c79](https://github.com/syscode-labs/omni-on-unraid/commit/8873c79f96c61edacbb3f9259d2eeb9649b04d62))
* **unraid:** schedule Hubble on control planes ([bf868e4](https://github.com/syscode-labs/omni-on-unraid/commit/bf868e4d04c40c1d099510cd5f0126017f978e67))
* use typed Kubernetes patches for libvirt Talos 1.14 ([0a88bc1](https://github.com/syscode-labs/omni-on-unraid/commit/0a88bc113966c40e81eac79af6a012fd897ce101))
